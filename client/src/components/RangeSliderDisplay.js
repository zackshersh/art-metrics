...
function RangeSliderDisplay({value, valueName, minLabel, maxLabel, verticallyCompact}) {
    ...
    return (
        ...
        }} className={`p-1 pl-1 mb-[0.15rem] bg-stone-100 ${verticallyCompact ? "h-10" : "h-[60px]"} rounded-md  border border-stone-400 bg-stone-100 flex items-center justify-between *:mr-3`}>
